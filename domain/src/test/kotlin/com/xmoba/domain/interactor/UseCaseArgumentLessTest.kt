...
class UseCaseArgumentlessTest {
    ...
    class UseCaseTestClass constructor(threadExecutor: ThreadExecutor, postExecutionThread: PostExecutionThread) : UseCaseArgumentless<Any>(threadExecutor, postExecutionThread) {
